...
1. Runtime validation on real hardware — the port is compile-clean, but neither
   ...
   a console yet. Tracked in [issue #5](https://github.com/liz-baker/libultraship-wiiu/issues/5)
   and exercised by an on-hardware test harness that lives in a separate
